...
NEWS_ARTICLES = [
    {
        "id": 1,
        "title": "RBI Keeps Repo Rate Unchanged at 6.5% — Signals Cautious Stance Amid Global Uncertainty",
        "summary": "The Reserve Bank of India held the benchmark repo rate steady for the sixth consecutive meeting. Governor Das cited persistent food inflation risks and global geopolitical tensions as key concerns.",
        "source": "Economic Times",
        "category": "Policy",
        "timestamp": "1 hour ago",
        "related_symbols": ["SBIN", "HDFCBANK", "ICICIBANK"],
        "is_breaking": True,
    },
    {
        "id": 2,
        "title": "FIIs Turn Net Sellers — Pulled Out ₹4,200 Cr from Indian Equities This Week",
        "summary": "Foreign institutional investors continued their selling spree for the third consecutive week. Rising US bond yields and a stronger dollar index are driving capital outflows from emerging markets.",
        "source": "Moneycontrol",
        "category": "Market",
        "timestamp": "2 hours ago",
        "related_symbols": ["RELIANCE", "TCS"],
        "is_breaking": True,
    },
    {
        "id": 3,
        "title": "Tata Motors Q4 Preview — JLR Margins Expected to Improve on Strong Demand",
        "summary": "Analysts expect Tata Motors to report 18% YoY revenue growth driven by JLR recovery and strong domestic EV sales. EBITDA margins likely to expand 120bps to 14.8%.",
        "source": "CNBC-TV18",
        "category": "Stock",
    ...
    {
        "id": 4,
        "title": "NIFTY IT Index Rallies 2.5% as Rupee Weakness Boosts Export Earnings Outlook",
        "summary": "IT stocks surged across the board as the rupee touched a fresh low against the dollar. TCS, Infosys, and HCL Tech led the rally with gains of 2-3%.",
        "source": "LiveMint",
        "category": "Sector",
        "timestamp": "4 hours ago",
        "related_symbols": ["TCS", "INFY", "HCLTECH"],
        "is_breaking": False,
    },
    {
        "id": 5,
        "title": "Bajaj Finance Reports Strong Loan Growth — AUM Crosses ₹3.5 Lakh Crore",
        "summary": "Bajaj Finance posted a 28% growth in assets under management, beating street estimates. The NBFC giant added 4.2 million new customers in Q4, taking total customer base to 85 million.",
        "source": "Business Standard",
        "category": "Stock",
        "timestamp": "5 hours ago",
        "related_symbols": ["BAJFINANCE", "BAJAJFINSV"],
        "is_breaking": False,
    },
    {
        "id": 6,
        "title": "Oil Prices Surge Above $90 — Indian Oil Marketing Companies Under Pressure",
        "summary": "Brent crude jumped 3.2% to $91.5/barrel on Middle East tensions. BPCL, IOC, and HPCL fell 2-4% as investors worry about under-recoveries and potential fuel price hikes.",
        "source": "Economic Times",
        "category": "Global",
        "timestamp": "6 hours ago",
        "related_symbols": ["BPCL", "IOC", "HINDPETRO"],
        "is_breaking": False,
    },
    {
        "id": 7,
        "title": "Ola Electric IPO — Company Files DRHP for ₹7,500 Crore Public Offering",
        "summary": "Ola Electric Mobility filed its draft red herring prospectus with SEBI. The IPO includes a fresh issue of ₹5,500 crore and an offer for sale of ₹2,000 crore by existing shareholders.",
        "source": "Moneycontrol",
        "category": "IPO",
    ...
    {
        "id": 8,
        "title": "Pharma Sector Outlook: US FDA Approvals and Generic Pipeline Drive Optimism",
        "summary": "Brokerage firms have turned bullish on Indian pharma, citing improved USFDA inspection outcomes and a strong pipeline of ANDA approvals expected in H1 FY27.",
        "source": "CNBC-TV18",
        "category": "Sector",
        "timestamp": "10 hours ago",
        "related_symbols": ["SUNPHARMA", "DRREDDY", "CIPLA"],
        "is_breaking": False,
    },
    {
        "id": 9,
        "title": "Adani Group Stocks Rally — Adani Enterprises Up 5% on Port Expansion Plans",
        "summary": "Adani Enterprises jumped 5% after the company announced a ₹12,000 crore investment plan for expanding port capacity along the eastern coast. Other Adani group stocks followed suit.",
        "source": "LiveMint",
        "category": "Stock",
        "timestamp": "12 hours ago",
        "related_symbols": ["ADANIENT", "ADANIPORTS"],
        "is_breaking": False,
    },
    {
        "id": 10,
        "title": "SEBI Tightens Rules for F&O Trading — Minimum Lot Size Doubled",
        "summary": "Markets regulator SEBI approved new rules to curb speculative trading in derivatives. The minimum lot size for equity options will be doubled from ₹5 lakh to ₹10 lakh, effective May 1.",
        "source": "Business Standard",
        "category": "Policy",
        "timestamp": "1 day ago",
        "related_symbols": ["BSE", "MCX"],
        "is_breaking": False,
    },
    {
        "id": 11,
        "title": "US Fed Signals Rate Cuts — Wall Street Hits New All-Time Highs",
        "summary": "The Federal Reserve hinted at potential rate cuts in the second half of 2026. S&P 500 and Nasdaq both hit record highs, fueling optimism for global equity markets.",
        "source": "Economic Times",
        "category": "Global",
        "timestamp": "1 day ago",
        "related_symbols": [],
    ...
    {
        "id": 12,
        "title": "ITC Hotel Demerger — Record Date Set for April 10, Shares to Trade Separately",
        "summary": "ITC announced the record date for its hotel business demerger. Shareholders will receive 1 share of ITC Hotels for every 10 ITC shares held as of April 10, 2026.",
        "source": "Moneycontrol",
        "category": "Stock",
        "timestamp": "1 day ago",
        "related_symbols": ["ITC"],
    ...
    {
        "id": 13,
        "title": "India's GDP Growth at 7.2% — Fastest Among Major Economies",
        "summary": "India's GDP expanded 7.2% in Q3 FY26, beating estimates of 6.8%. Strong manufacturing and services PMI data point to continued momentum in the coming quarters.",
        "source": "LiveMint",
        "category": "Market",
    ...
    {
        "id": 14,
        "title": "Zomato Achieves Profitability — Posts First Full-Year PAT of ₹280 Crore",
        "summary": "Zomato reported its first full-year profit, driven by Blinkit's rapid growth and improved unit economics in food delivery. Quick commerce revenue grew 120% YoY.",
        "source": "CNBC-TV18",
        "category": "Stock",
        "timestamp": "2 days ago",
        "related_symbols": ["ZOMATO"],
        "is_breaking": False,
    },
    {
        "id": 15,
        "title": "Green Energy Push — Government Approves ₹50,000 Crore Solar Manufacturing PLI",
        "summary": "The cabinet approved an expanded PLI scheme for solar cell and module manufacturing. Adani Green, Tata Power, and Suzlon are seen as key beneficiaries of the policy push.",
        "source": "Business Standard",
        "category": "Policy",
        "timestamp": "3 days ago",
        "related_symbols": ["ADANIGREEN", "TATAPOWER", "SUZLON"],
        "is_breaking": False,
    },
]
